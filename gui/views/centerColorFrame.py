...
class CenterColorFrame:
    ...
    def __create_button(self, color_text: str, color: str) -> None:
        tk.Button(self.frame, activebackground=color, text=color_text, bg=color, width='6', height='3', font=('Arial', 8), command=lambda: self.controller.color_button_clicked(color_text, color)).pack(side='left')
